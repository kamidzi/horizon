...
def data(TEST):
    ...
    flavor_5 = flavors.Flavor(flavors.FlavorManager(None),
                              {'id': "ffffffff-ffff-ffff-ffff-ffffffffffff",
                               ...
                               'os-flavor-access:is_public': True,
                               'OS-FLV-EXT-DATA:ephemeral': 0})
    flavor_6 = flavors.Flavor(flavors.FlavorManager(None),
                              {'id': "gggggggg-gggg-gggg-gggg-gggggggggggg",
                               ...
                               'os-flavor-access:is_public': True,
                               'OS-FLV-EXT-DATA:ephemeral': 2048})
    flavor_7 = flavors.Flavor(flavors.FlavorManager(None),
                              {'id': "hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh",
                               'name': 'nondurable1.massive',
                               'vcpus': 1000,
                               'disk': 1024,
                               'ram': 10000,
                               'swap': 0,
